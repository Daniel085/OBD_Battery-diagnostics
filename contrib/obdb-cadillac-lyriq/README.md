...
- `tests/test_cases/2024/commands/*.yaml` — real captured request/response pairs
  with expected decoded values. Each signal's formula reproduces its test value
...
2. Copy `signalsets/v3/default.json` and the `tests/test_cases/2024/commands/*.yaml`
